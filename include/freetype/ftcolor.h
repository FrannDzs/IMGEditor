 ...
 */
FT_EXPORT(FT_Bool)
FT_Get_Color_Glyph_Layer(FT_Face face, FT_UInt base_glyph,
                         FT_UInt *aglyph_index, FT_UInt *acolor_index,
                         FT_LayerIterator *iterator);
 ...
 */
FT_EXPORT(FT_Bool)
FT_Get_Color_Glyph_Paint(FT_Face face, FT_UInt base_glyph,
 ...
 */
FT_EXPORT(FT_Bool)
FT_Get_Color_Glyph_ClipBox(FT_Face face, FT_UInt base_glyph,
                           FT_ClipBox *clip_box);
 ...
 */
FT_EXPORT(FT_Bool)
FT_Get_Colorline_Stops(FT_Face face, FT_ColorStop *color_stop,
