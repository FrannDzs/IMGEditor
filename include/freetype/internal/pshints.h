...
typedef void (*PSH_Globals_SetScaleFunc)(PSH_Globals globals, FT_Fixed x_scale,
                                         FT_Fixed y_scale, FT_Fixed x_delta,
                                         FT_Fixed y_delta);
 ...
 *
 */
typedef void (*T1_Hints_SetStemFunc)(T1_Hints hints, FT_UInt dimension,
                                     FT_Fixed *coords);
 ...
 *
 */
typedef void (*T1_Hints_SetStem3Func)(T1_Hints hints, FT_UInt dimension,
                                      FT_Fixed *coords);
 ...
 *
 */
typedef FT_Error (*T1_Hints_ApplyFunc)(T1_Hints hints, FT_Outline *outline,
                                       PSH_Globals globals,
 ...
 *
 */
typedef void (*T2_Hints_StemsFunc)(T2_Hints hints, FT_UInt dimension,
                                   FT_Int count, FT_Fixed *coordinates);
 ...
 *
 */
typedef void (*T2_Hints_MaskFunc)(T2_Hints hints, FT_UInt end_point,
                                  FT_UInt bit_count, const FT_Byte *bytes);
 ...
 *
 */
typedef void (*T2_Hints_CounterFunc)(T2_Hints hints, FT_UInt bit_count,
                                     const FT_Byte *bytes);
 ...
 *
 */
typedef FT_Error (*T2_Hints_ApplyFunc)(T2_Hints hints, FT_Outline *outline,
                                       PSH_Globals globals,
                                       FT_Render_Mode hint_mode);
...
#define FT_DEFINE_PSHINTER_INTERFACE(class_, get_globals_funcs_,               \
  ...
  static const PSHinter_Interface class_ = {get_globals_funcs_, get_t1_funcs_, \
                                            get_t2_funcs_};
