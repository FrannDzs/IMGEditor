...
typedef FT_Error (*FT_Face_InitFunc)(FT_Stream stream, FT_Face face,
                                     FT_Int typeface_index, FT_Int num_params,
...
typedef FT_Error (*FT_Slot_LoadFunc)(FT_GlyphSlot slot, FT_Size size,
                                     FT_UInt glyph_index, FT_Int32 load_flags);

typedef FT_Error (*FT_Face_GetKerningFunc)(FT_Face face, FT_UInt left_glyph,
                                           FT_UInt right_glyph,
                                           FT_Vector *kerning);

typedef FT_Error (*FT_Face_AttachFunc)(FT_Face face, FT_Stream stream);

typedef FT_Error (*FT_Face_GetAdvancesFunc)(FT_Face face, FT_UInt first,
                                            FT_UInt count, FT_Int32 flags,
                                            FT_Fixed *advances);
...
#define FT_DEFINE_DRIVER(                                                      \
    class_, flags_, size_, name_, version_, requires_, interface_, init_,      \
    done_, get_interface_, face_object_size_, size_object_size_,               \
    slot_object_size_, init_face_, done_face_, init_size_, done_size_,         \
    init_slot_, done_slot_, load_glyph_, get_kerning_, attach_file_,           \
