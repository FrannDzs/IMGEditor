...
typedef struct PS_Table_FuncsRec_ {
  ...
  FT_Error (*add)(PS_Table table, FT_Int idx, const void *object,
                  FT_UInt length);
...
#define T1_NEW_SIMPLE_FIELD(_ident, _type, _fname, _dict)                      \
  {_ident, T1CODE, _type, 0, FT_FIELD_OFFSET(_fname), FT_FIELD_SIZE(_fname),   \
   0,      0,      _dict},
...
#define T1_FIELD_FIXED_1000(_ident, _fname, _dict)                             \
  T1_NEW_SIMPLE_FIELD(_ident, T1_FIELD_TYPE_FIXED_1000, _fname, _dict)
...
#define T1_FIELD_NUM_TABLE(_ident, _fname, _fmax, _dict)                       \
  T1_NEW_TABLE_FIELD(_ident, T1_FIELD_TYPE_INTEGER_ARRAY, _fname, _fmax, _dict)

#define T1_FIELD_FIXED_TABLE(_ident, _fname, _fmax, _dict)                     \
  T1_NEW_TABLE_FIELD(_ident, T1_FIELD_TYPE_FIXED_ARRAY, _fname, _fmax, _dict)

#define T1_FIELD_NUM_TABLE2(_ident, _fname, _fmax, _dict)                      \
  T1_NEW_TABLE_FIELD2(_ident, T1_FIELD_TYPE_INTEGER_ARRAY, _fname, _fmax, _dict)

#define T1_FIELD_FIXED_TABLE2(_ident, _fname, _fmax, _dict)                    \
  T1_NEW_TABLE_FIELD2(_ident, T1_FIELD_TYPE_FIXED_ARRAY, _fname, _fmax, _dict)
...
typedef struct PS_Parser_FuncsRec_ {
  void (*init)(PS_Parser parser, FT_Byte *base, FT_Byte *limit,
               FT_Memory memory);
  ...
  FT_Error (*to_bytes)(PS_Parser parser, FT_Byte *bytes, FT_Offset max_bytes,
                       FT_ULong *pnum_bytes, FT_Bool delimiters);

  FT_Int (*to_coord_array)(PS_Parser parser, FT_Int max_coords,
                           FT_Short *coords);
  FT_Int (*to_fixed_array)(PS_Parser parser, FT_Int max_values,
                           FT_Fixed *values, FT_Int power_ten);

  void (*to_token)(PS_Parser parser, T1_Token token);
  void (*to_token_array)(PS_Parser parser, T1_Token tokens, FT_UInt max_tokens,
                         FT_Int *pnum_tokens);

  FT_Error (*load_field)(PS_Parser parser, const T1_Field field, void **objects,
                         FT_UInt max_objects, FT_ULong *pflags);

  FT_Error (*load_field_table)(PS_Parser parser, const T1_Field field,
                               void **objects, FT_UInt max_objects,
                               FT_ULong *pflags);
...
typedef FT_Error (*CFF_Decoder_Get_Glyph_Callback)(TT_Face face,
                                                   FT_UInt glyph_index,
                                                   FT_Byte **pointer,
                                                   FT_ULong *length);

typedef void (*CFF_Decoder_Free_Glyph_Callback)(TT_Face face, FT_Byte **pointer,
                                                FT_ULong length);
...
typedef void (*T1_Builder_Add_Point_Func)(T1_Builder builder, FT_Pos x,
                                          FT_Pos y, FT_Byte flag);

typedef FT_Error (*T1_Builder_Add_Point1_Func)(T1_Builder builder, FT_Pos x,
                                               FT_Pos y);

typedef FT_Error (*T1_Builder_Add_Contour_Func)(T1_Builder builder);

typedef FT_Error (*T1_Builder_Start_Point_Func)(T1_Builder builder, FT_Pos x,
                                                FT_Pos y);
...
typedef struct T1_Builder_FuncsRec_ {
  void (*init)(T1_Builder builder, FT_Face face, FT_Size size,
               FT_GlyphSlot slot, FT_Bool hinting);
...
typedef struct T1_Decoder_FuncsRec_ {
  FT_Error (*init)(T1_Decoder decoder, FT_Face face, FT_Size size,
                   FT_GlyphSlot slot, FT_Byte **glyph_names, PS_Blend blend,
  ...
  FT_Error (*parse_charstrings_old)(T1_Decoder decoder, FT_Byte *base,
                                    FT_UInt len);
#else
  FT_Error (*parse_metrics)(T1_Decoder decoder, FT_Byte *base, FT_UInt len);
#endif

  FT_Error (*parse_charstrings)(PS_Decoder *decoder, FT_Byte *charstring_base,
...
typedef FT_Error (*CFF_Builder_Check_Points_Func)(CFF_Builder *builder,
                                                  FT_Int count);

typedef void (*CFF_Builder_Add_Point_Func)(CFF_Builder *builder, FT_Pos x,
                                           FT_Pos y, FT_Byte flag);
typedef FT_Error (*CFF_Builder_Add_Point1_Func)(CFF_Builder *builder, FT_Pos x,
                                                FT_Pos y);
typedef FT_Error (*CFF_Builder_Start_Point_Func)(CFF_Builder *builder, FT_Pos x,
                                                 FT_Pos y);
...
typedef struct CFF_Builder_FuncsRec_ {
  void (*init)(CFF_Builder *builder, TT_Face face, CFF_Size size,
               CFF_GlyphSlot glyph, FT_Bool hinting);
...
typedef struct CFF_Decoder_FuncsRec_ {
  void (*init)(CFF_Decoder *decoder, TT_Face face, CFF_Size size,
               CFF_GlyphSlot slot, FT_Bool hinting, FT_Render_Mode hint_mode,
  ...
  FT_Error (*parse_charstrings_old)(CFF_Decoder *decoder,
                                    FT_Byte *charstring_base,
                                    FT_ULong charstring_len, FT_Bool in_dict);
#endif
...
typedef struct AFM_Parser_FuncsRec_ {
  FT_Error (*init)(AFM_Parser parser, FT_Memory memory, FT_Byte *base,
                   FT_Byte *limit);
