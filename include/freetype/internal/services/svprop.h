...
typedef FT_Error (*FT_Properties_SetFunc)(FT_Module module,
                                          const char *property_name,
                                          const void *value,
                                          FT_Bool value_is_string);

typedef FT_Error (*FT_Properties_GetFunc)(FT_Module module,
                                          const char *property_name,
                                          void *value);
...
#define FT_DEFINE_SERVICE_PROPERTIESREC(class_, set_property_, get_property_)  \
  static const FT_Service_PropertiesRec class_ = {set_property_, get_property_};
