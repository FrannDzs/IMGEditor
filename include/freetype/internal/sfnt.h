 ...
 */
typedef FT_Error (*TT_Init_Face_Func)(FT_Stream stream, TT_Face face,
                                      FT_Int face_index, FT_Int num_params,
                                      FT_Parameter *params);
 ...
 */
typedef FT_Error (*TT_Load_Face_Func)(FT_Stream stream, TT_Face face,
                                      FT_Int face_index, FT_Int num_params,
                                      FT_Parameter *params);
 ...
 */
typedef FT_Error (*TT_Load_Any_Func)(TT_Face face, FT_ULong tag, FT_Long offset,
 ...
 */
typedef FT_Error (*TT_Find_SBit_Image_Func)(TT_Face face, FT_UInt glyph_index,
 ...
 *   function exit.
 */
typedef FT_Error (*TT_Load_SBit_Metrics_Func)(FT_Stream stream,
                                              TT_SBit_Range range,
 ...
 */
typedef FT_Error (*TT_Load_SBit_Image_Func)(TT_Face face, FT_ULong strike_index,
                                            FT_UInt glyph_index,
                                            FT_UInt load_flags,
                                            FT_Stream stream, FT_Bitmap *amap,
 ...
 *   FreeType error code.  0 means success.
 */
typedef FT_Error (*TT_Load_Svg_Doc_Func)(FT_GlyphSlot glyph,
                                         FT_UInt glyph_index);
 ...
 */
typedef FT_Error (*TT_Set_SBit_Strike_Func)(TT_Face face, FT_Size_Request req,
 ...
 *   sbit strike exists.
 */
typedef FT_Error (*TT_Load_Strike_Metrics_Func)(TT_Face face,
                                                FT_ULong strike_index,
 ...
 *   FreeType error code.  0 means success.
 */
typedef FT_Error (*TT_Get_PS_Name_Func)(TT_Face face, FT_UInt idx,
                                        FT_String **PSname);
 ...
 *   FreeType error code.  0 means success.
 */
typedef FT_Error (*TT_Load_Metrics_Func)(TT_Face face, FT_Stream stream,
                                         FT_Bool vertical);
 ...
 */
typedef void (*TT_Get_Metrics_Func)(TT_Face face, FT_Bool vertical,
                                    FT_UInt gindex, FT_Short *abearing,
                                    FT_UShort *aadvance);
 ...
 */
typedef FT_Bool (*TT_Get_Colr_Layer_Func)(TT_Face face, FT_UInt base_glyph,
 ...
 */
typedef FT_Bool (*TT_Get_Color_Glyph_Paint_Func)(
 ...
 */
typedef FT_Bool (*TT_Get_Color_Glyph_ClipBox_Func)(TT_Face face,
                                                   FT_UInt base_glyph,
                                                   FT_ClipBox *clip_box);
 ...
 *   also.
 */
typedef FT_Bool (*TT_Get_Colorline_Stops_Func)(TT_Face face,
 ...
 */
typedef FT_Bool (*TT_Get_Paint_Func)(TT_Face face, FT_OpaquePaint opaque_paint,
                                     FT_COLR_Paint *paint);
 ...
 */
typedef FT_Error (*TT_Blend_Colr_Func)(TT_Face face, FT_UInt color_index,
 ...
 *   FreeType error code.  0 means success.
 */
typedef FT_Error (*TT_Get_Name_Func)(TT_Face face, FT_UShort nameid,
                                     FT_String **name);
 ...
 */
typedef FT_Bool (*TT_Get_Name_ID_Func)(TT_Face face, FT_UShort nameid,
                                       FT_Int *win, FT_Int *apple);
 ...
 */
typedef FT_Int (*TT_Face_GetKerningFunc)(TT_Face face, FT_UInt left_glyph,
                                         FT_UInt right_glyph);
...
#define FT_DEFINE_SFNT_INTERFACE(                                              \
    class_, goto_table_, init_face_, load_face_, done_face_, get_interface_,   \
    load_any_, load_head_, load_hhea_, load_cmap_, load_maxp_, load_os2_,      \
    load_post_, load_name_, free_name_, load_kern_, load_gasp_, load_pclt_,    \
    load_bhed_, load_sbit_image_, get_psname_, free_psnames_, get_kerning_,    \
    load_font_dir_, load_hmtx_, load_eblc_, free_eblc_, set_sbit_strike_,      \
    load_strike_metrics_, load_cpal_, load_colr_, free_cpal_, free_colr_,      \
    set_palette_, get_colr_layer_, get_colr_glyph_paint_,                      \
    get_color_glyph_clipbox, get_paint_layers_, get_colorline_stops_,          \
    get_paint_, colr_blend_, get_metrics_, get_name_, get_name_id_, load_svg_, \
    free_svg_, load_svg_doc_)                                                  \
  static const SFNT_Interface class_ = {goto_table_,                           \
                                        init_face_,                            \
                                        load_face_,                            \
                                        done_face_,                            \
                                        get_interface_,                        \
