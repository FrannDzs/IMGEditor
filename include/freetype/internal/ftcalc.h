 ...
 */
FT_BASE(FT_Int32)
FT_MulAddFix(FT_Fixed *s, FT_Int32 *f, FT_UInt count);
 ...
 */
FT_BASE(void)
FT_Vector_Transform_Scaled(FT_Vector *vector, const FT_Matrix *matrix,
                           FT_Long scaling);
...
extern __inline FT_Int32 FT_MSB_i386(FT_UInt32 x);
