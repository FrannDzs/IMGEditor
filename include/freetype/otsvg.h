 ...
 *   2.12
 */
typedef FT_Error (*SVG_Lib_Init_Func)(FT_Pointer *data_pointer);
 ...
 *   2.12
 */
typedef FT_Error (*SVG_Lib_Render_Func)(FT_GlyphSlot slot,
 ...
 *   2.12
 */
typedef FT_Error (*SVG_Lib_Preset_Slot_Func)(FT_GlyphSlot slot, FT_Bool cache,
                                             FT_Pointer *state);
