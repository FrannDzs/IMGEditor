  ...
  if (ImGui::CollapsingHeader("Inputs, Navigation & Focus")) {
    ...
    if (ImGui::TreeNode("Keyboard, Gamepad & Navigation State")) {
      ...
      // Draw an arbitrary US keyboard layout to visualize translated keys
      {
        ...
        ImGui::Dummy(
            ImVec2(board_max.x - board_min.x, board_max.y - board_min.y));
        if (ImGui::IsItemVisible()) {
          ...
          for (int n = 0; n < IM_ARRAYSIZE(keys_to_display); n++) {
            ...
            ImVec2 key_max =
                ImVec2(key_min.x + key_size.x, key_min.y + key_size.y);
            ...
            ImVec2 face_max = ImVec2(face_min.x + key_face_size.x,
            ...
            draw_list->AddRectFilled(face_min, face_max,
                                     ...
                                     key_face_rounding);
            ImVec2 label_min = ImVec2(key_min.x + key_label_pos.x,
