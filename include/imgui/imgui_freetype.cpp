...
//  2021/08/23: fixed crash when FT_Render_Glyph() fails to render a glyph and
//  returns NULL. 2021/03/05: added ImGuiFreeTypeBuilderFlags_Bitmap to load
//  bitmap glyphs. 2021/03/02: set 'atlas->TexPixelsUseColors = true' to help
//  some backends with deciding of a prefered texture format. 2021/01/28: added
//  support for color-layered glyphs via ImGuiFreeTypeBuilderFlags_LoadColor
//  (require Freetype 2.10+). 2021/01/26: simplified integration by using
//  '#define IMGUI_ENABLE_FREETYPE'.
//              renamed ImGuiFreeType::XXX flags to
//              ImGuiFreeTypeBuilderFlags_XXX for consistency with other API.
//              removed ImGuiFreeType::BuildFontAtlas().
...
bool ImFontAtlasBuildWithFreeTypeEx(FT_Library ft_library, ImFontAtlas *atlas,
  ...
  // won't find the temporary allocations.
  ...
  stbrp_init_target(&pack_context, atlas->TexWidth, TEX_HEIGHT_MAX,
