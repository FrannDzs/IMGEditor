...
Ui::Application::~Application() { Renderer::Shutdown(); }

void Ui::Application::SetPopup(std::function<void()> Func) {
  Info.PopupFunc = Func;
}

Ui::CVector2 Ui::Application::GetWindowSize() { return Info.Size; }

Ui::eTheme Ui::Application::GetTheme() { return Ui::Renderer::GetThemeMode(); }
