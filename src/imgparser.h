...
public:
  ...
  virtual void Export(IMGArchive *pMgr, EntryInfo *pEntry,
                      const std::string &filePath, bool logMsg = true) = 0;

  // Imports an entity to the archive
  virtual void Import(IMGArchive *pArc, const std::string &path,
                      bool replace) = 0;
...
public:
  ...
  void Export(IMGArchive *pMgr, EntryInfo *pEntry, const std::string &filePath,
              bool logMsg = true);
